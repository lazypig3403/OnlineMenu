...
public class MoreDiscount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more_discount);

        searchlist = (RecyclerView) findViewById(R.id.MoreDiscount_listView);
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(MoreDiscount.this, DishDetail.class);
